import{_ as n,o as s,c as a,N as t}from"./chunks/framework.27c7f8b4.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/reg.md","lastUpdated":1683254164000}'),p={name:"docs/reg.md"},e=t(`<h2 id="是否为外部-url" tabindex="-1">是否为外部 URL <a class="header-anchor" href="#是否为外部-url" aria-label="Permalink to &quot;是否为外部 URL&quot;">​</a></h2><p>方法名：<code>isExternal</code></p><div class="language-ts"><pre><code><span class="token comment">/**
 * @title 验证是否为外部URL
 * @param {string} path
 * @return {boolean}
 */</span>
